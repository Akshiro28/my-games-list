function Footer() {
  return (
    <>
      <footer className="container absolute w-[calc(100%-32px)] translate-x-[-50%] left-1/2 bottom-4 bg-[var(--thin)] rounded-lg h-14 md:h-18 flex justify-between py-5 md:px-10 px-5">
